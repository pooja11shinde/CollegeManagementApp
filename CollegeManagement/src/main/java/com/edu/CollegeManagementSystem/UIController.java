package com.edu.CollegeManagementSystem;
...
import com.edu.CollegeManagementSystem.Entity.Student;
import com.edu.CollegeManagementSystem.Entity.Teacher;
import com.edu.CollegeManagementSystem.service.CourseService;
import com.edu.CollegeManagementSystem.service.StudentService;
import com.edu.CollegeManagementSystem.service.TeacherService;
...
public String saveCourse(@Valid  Course course, Errors errors, Model model) {
	if(null != errors && errors.getErrorCount() > 0)
		return "redirect:/";
	else {
